...
/**
 * @deprecated Use App\Support\Validator instead.
...
if ($__dep !== '' && $__dep !== '0' && strtolower((string)$__dep) !== 'off') {
	$__msg = 'Deprecated class App\\Validator (root wrapper). Use App\\Support\\Validator instead.';
	if ($__dep === 'log') { @error_log($__msg); } else { @trigger_error($__msg, E_USER_DEPRECATED); }
}
unset($__dep, $__msg);
class Validator extends \App\Support\Validator {}
